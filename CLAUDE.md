...
- `src/index.ts` — Server entry point, Fastify setup, MCP session management
...
- `src/rest/proxy.ts` — REST API routes and generic Graph API proxy
...
- `MCP_API_KEY` (optional) — API key for HTTP auth
